...
Verified headless on a production body retopo (3 edges collapsed): the geometry
delta matches native Collapse exactly (-3 verts / -4 faces) while the total UV
area is unchanged (native loses area = pinch).
"""
