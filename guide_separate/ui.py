...
class AC9_PT_GuideSeparateSettings(bpy.types.Panel):
    ...
    # No poll: Contact / Separate came out of Experimental on 2026-09-09
    # (production judgement: the coarse-grid solver made it usable), so its
    # tuning knobs are shown like any other panel's.
