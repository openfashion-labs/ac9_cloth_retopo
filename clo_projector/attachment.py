...
from .geometry import barycentric_xy
...
def build_bvh_2d(triangles_2d_world: Sequence[Triangle]) -> BVHTree:
    """Build a Z=0-flattened BVH over the Guide 2D triangles.
